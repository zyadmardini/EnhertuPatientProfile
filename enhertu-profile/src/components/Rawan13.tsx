...
export default function Rawan13({ onBackClick, onHomeClick, onContinueClick }: Rawan13Props) {
  return (
    <div style={{ 
      position: 'relative', 
      width: '1080px', 
    ...
    }} data-name="Rawan13" data-node-id="52:1838">
      ...
      >
        <p style={{ margin: 0, lineHeight: 'normal' }}>Patient responds to ENHERTU</p>
      </div>
      ...
      >
        <p style={{ margin: 0, lineHeight: '28px' }}>
          <span>CT (3 mo): </span>
          <span style={{ fontWeight: '500' }}>Partial response (liver), stable disease (lymph nodes,</span>
        </p>
        <p style={{ margin: 0, lineHeight: '28px', fontWeight: '500' }}>
          lung and bone)
        </p>
      </div>
      ...
      >
        ...
        <p style={{ margin: 0, lineHeight: '28px' }}>(Sept 2022)</p>
      </div>
      ...
      >
        <p style={{ margin: 0, lineHeight: '28px' }}>During ENHERTU treatment CT (Jan 2023)</p>
      </div>
      ...
      >
        ...
        >
          <p style={{ margin: 0, lineHeight: '54px' }}>Continue</p>
        </div>
      </div>
