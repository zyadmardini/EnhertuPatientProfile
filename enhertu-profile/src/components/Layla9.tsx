...
export default function Layla9({ onContinueClick, onBackClick, onHomeClick }: Layla9Props) {
  return (
    <div style={{ 
      position: 'relative', 
      width: '1080px', 
      ...
      >
        ...
        >
          <ul style={{ listStyleType: 'disc', marginLeft: '46.5px' }}>
            ...
            <li>
              Prophylactic antiemetics (dexamethasone
            </li>
          </ul>
        </div>
        ...
        >
          <p style={{ margin: 0 }}>
            + ondansetron + aprepitant) were given to prevent nausea and vomiting
          </p>
        </div>
      ...
      >
        <p style={{ margin: 0 }}>
          ENHERTU EU Summary of Product Characteristics 2023. Available at: https://www.ema.europa.eu/en/documents/product-information/enhertu-epar-product-information_en.pdf. Accessed January 2024.
        </p>
      </div>
    </div>
  );
