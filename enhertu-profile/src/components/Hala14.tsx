...
const imgImage23 = "/assets/951bcea9723a9671481170f86dd739c378b6226.png";
...
export default function Hala14({ onContinueClick, onBackClick, onHomeClick }: Hala14Props) {
  return (
    <div style={{ 
      position: 'relative', 
      width: '1080px', 
      ...
      >
        Patient rechallenged following resolution of<br />
      ...
      >
        <p style={{ margin: 0, marginBottom: '8px' }}>Asymptomatic</p>
        <ul style={{ margin: 0, paddingLeft: '21px' }}>
          <li style={{ marginBottom: '4px' }}>
            Prednisone continued at 0.5 mg/kg/day for 3 weeks followed by gradual taper of over<br />
            4 weeks
          </li>
        </ul>
      </div>
      ...
      >
        <p style={{ margin: 0, marginBottom: '0px' }}>After holding ENHERTU</p>
        <p style={{ margin: 0, marginBottom: '0px' }}>for 49 days and tapering</p>
        <p style={{ margin: 0 }}>off prednisolone completely</p>
      </div>
      ...
      >
        <p style={{ margin: 0, marginBottom: '8px' }}>Asymptomatic</p>
        <ul style={{ margin: 0, paddingLeft: '21px' }}>
          <li style={{ marginBottom: '4px' }}>Normal lung function</li>
          <li style={{ marginBottom: '4px' }}>Normal 6 min walk test</li>
          <li style={{ marginBottom: '4px' }}>
            Started prednisone<br />
            0.5 mg/kg/day
          </li>
          <li>Initiate prophylactic antibiotics for PCP</li>
        </ul>
      </div>
      ...
      >
        <p style={{ margin: 0, marginBottom: '8px' }}>Resolved</p>
        <ul style={{ margin: 0, paddingLeft: '21px' }}>
          <li>
            Rechallenged: Cycle 4<br />
            at 4.4 mg/kg/day
          </li>
        </ul>
        </div>
      ...
      >
        <p style={{ margin: 0, marginBottom: '0px' }}>
          Case built with input from Dr Simon Gampenrieder, University Hospital Salzburg, Austria.
        </p>
        <p style={{ margin: 0 }}>resp med, respiratory medicine.</p>
      </div>
    </div>
  );
}