...
const imgVector = "http://localhost:3845/assets/f74766b67109569552a5a61be5a8cfb9605d8c13.svg";
const imgVector1 = "http://localhost:3845/assets/0a8f93ce89120f39f92a645ee9cb2f0b34eb570c.svg";
...
export default function Samira3({ onBackClick, onHomeClick, onContinueClick }: Samira3Props) {
  return (
    <div style={{ 
      position: 'relative', 
      width: '1080px', 
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <ul style={{ margin: 0, paddingLeft: '46.5px' }}>
            <li style={{ marginBottom: 0 }}>
              <span>Patient started docetaxel + trastuzumab + pertuzumab treatment in July 2021</span>
            </li>
          </ul>
          <p style={{ margin: 0 }}>&nbsp;</p>
        </div>
        ...
        <div style={{ 
          ...
          <ul style={{ margin: 0, paddingLeft: '46.5px' }}>
            <li style={{ marginBottom: 0 }}>
              <span>Treatment was given for 6 cycles</span>
            </li>
            <li style={{ marginBottom: 0 }}>
              <span>Trastuzumab + pertuzumab + letrozole was given as maintenance therapy until October 2022</span>
            </li>
            <li>
              <span>There was an initial partial response followed by stable disease</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <ul style={{ margin: 0, paddingLeft: '46.5px' }}>
            <li>
              <span>Following 1L treatment, the patient demonstrated a PFS of 15 months.</span>
            </li>
          </ul>
        </div>
        ...
        <div style={{ 
          ...
          <ul style={{ margin: 0, paddingLeft: '46.5px' }}>
            <li>
              <span>Disease progression in the bone was observed in October 2022</span>
            </li>
          </ul>
        </div>
      </div>
