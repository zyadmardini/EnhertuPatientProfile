...
export default function Hala11({ onContinueClick, onBackClick, onHomeClick }: Hala11Props) {
  return (
    <div style={{ 
      position: 'relative', 
      width: '1080px', 
      ...
      <div data-enter-group data-enter-delay="0.3" data-enter-stagger="0.1">
        {/* Left image */}
        <div 
          data-enter-order="1"
          style={{ 
      ...
      <div data-enter-group data-enter-delay="0.5" data-enter-stagger="0.1">
        {/* Left image */}
        <div 
          data-enter-order="1"
          style={{ 
