...
export default function Rawan4({
  onContinueClick,
  onBackClick,
  onHomeClick,
}: Rawan4Props) {
    ...
    >
      ...
      >
        ...
        <div
          ...
          data-oid=".b1_aiw"
        >
          <span style={{ fontWeight: "bold" }} data-oid="b38jdgv">
            1L treatment:
          </span>{" "}
        ...
        <div
          ...
          data-oid="uqp.c3s"
        >
          <span style={{ fontWeight: "bold" }} data-oid="w3_4mhq">
            CT (24 mo):
          </span>{" "}
          Progressive disease (lymph nodes, liver, lung)
        </div>
        ...
        <div
          ...
          data-oid="onyq6y3"
        >
          <span style={{ fontWeight: "bold" }} data-oid="621::o7">
            2L treatment:
          </span>{" "}
        ...
        <div
          ...
          data-oid="5v-3odd"
        >
          <span style={{ fontWeight: "bold" }} data-oid="76tueq6">
            CT (8 mo):
          </span>{" "}
        ...
        <div
          ...
          data-oid="vr4d50n"
        >
          <span style={{ fontWeight: "bold" }} data-oid="64nob67">
            3L treatment:
          </span>{" "}
        ...
        <div
          ...
          data-oid="0rah3rb"
        >
          <span style={{ fontWeight: "bold" }} data-oid="mz9qd8j">
            Best response:
          </span>{" "}
          Stable disease
        </div>
        ...
        <div
          ...
          data-oid="79si0nv"
        >
          <span style={{ fontWeight: "bold" }} data-oid="lnw-qkt">
            CT (12 mo):
          </span>{" "}
          Progressive disease (liver and lung)
        </div>
