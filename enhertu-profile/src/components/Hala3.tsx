...
export default function Hala3({ onContinueClick, onBackClick, onHomeClick }: Hala3Props) {
  return (
    <div style={{ 
      position: 'relative', 
      width: '1080px', 
      ...
      >
        Patient progresses after<br />
        less than one year of 1L<br />
      ...
      >
        ...
        <div style={{ position: 'relative', width: '100%', height: '96px', marginBottom: '29px' }}>
          ...
          >
            <span style={{ fontWeight: 'bold' }}>1L treatment: </span>
            <span>Paclitaxel + pembrolizumab</span>
          </div>
          <div 
            style={{ 
              position: 'absolute',
        ...
        <div style={{ position: 'relative', width: '100%', height: '96px', marginBottom: '29px' }}>
          ...
          >
            Remained on therapy for 9 months, taxane stopped after 6 months as she began to have neuropathy, and then continued pembrolizumab maintenance
          </div>
          <div 
            style={{ 
              position: 'absolute',
        ...
        <div style={{ position: 'relative', width: '100%', height: '96px' }}>
          ...
          >
            <span style={{ fontWeight: 'bold' }}>CT (9 mo): </span>
            <span>Progressive disease (liver, skin, lymph nodes)</span>
          </div>
          <div 
            style={{ 
              position: 'absolute',
      ...
      >
        Hypothetical case built with input from Dr Simon Gampenrieder, University Hospital Salzburg, Austria. 1L, first-line; CT, computed tomography; mBC, metastatic breast cancer.
      </div>
    </div>
  );
}
